...
var seq__1630_1634 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1631_1635 = null;
var count__1632_1636 = (0);
var i__1633_1637 = (0);
while(true){
if((i__1633_1637 < count__1632_1636)){
var str_1638 = cljs.core._nth.call(null,chunk__1631_1635,i__1633_1637);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1638})));


var G__1639 = seq__1630_1634;
var G__1640 = chunk__1631_1635;
var G__1641 = count__1632_1636;
var G__1642 = (i__1633_1637 + (1));
seq__1630_1634 = G__1639;
chunk__1631_1635 = G__1640;
count__1632_1636 = G__1641;
i__1633_1637 = G__1642;
continue;
} else {
var temp__5804__auto___1643 = cljs.core.seq.call(null,seq__1630_1634);
if(temp__5804__auto___1643){
var seq__1630_1644__$1 = temp__5804__auto___1643;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1630_1644__$1)){
var c__5565__auto___1645 = cljs.core.chunk_first.call(null,seq__1630_1644__$1);
var G__1646 = cljs.core.chunk_rest.call(null,seq__1630_1644__$1);
var G__1647 = c__5565__auto___1645;
var G__1648 = cljs.core.count.call(null,c__5565__auto___1645);
var G__1649 = (0);
seq__1630_1634 = G__1646;
chunk__1631_1635 = G__1647;
count__1632_1636 = G__1648;
i__1633_1637 = G__1649;
continue;
} else {
var str_1650 = cljs.core.first.call(null,seq__1630_1644__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1650})));


var G__1651 = cljs.core.next.call(null,seq__1630_1644__$1);
var G__1652 = null;
var G__1653 = (0);
var G__1654 = (0);
seq__1630_1634 = G__1651;
chunk__1631_1635 = G__1652;
count__1632_1636 = G__1653;
i__1633_1637 = G__1654;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1659 = script;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__1659,"type","text/javascript");

clojure.browser.repl.goog$module$goog$object.set.call(null,G__1659,"onload",onload);

clojure.browser.repl.goog$module$goog$object.set.call(null,G__1659,"onreadystatechange",onload);

return G__1659;
})();
if((opt_sourceText == null)){
var G__1660 = script__$1;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__1660,"src",src);

return G__1660;
} else {
var G__1661 = script__$1;
goog.dom.setTextContent(G__1661,opt_sourceText);
...
var path_1662 = goog.debugLoader_.getPathFromDeps_(src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,path_1662);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1662)].join(''));
} else {
var path_1663 = clojure.browser.repl.goog$module$goog$object.get.call(null,goog.dependencies_.nameToPath,src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.visited,path_1663);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,path_1663);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1663)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1664 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1665 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1665);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1664);
}})()})));
}));
